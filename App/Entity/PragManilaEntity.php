<?php
    ...
    class PragManilaEntity{
        ...
        function Human_delete(int $id){
            $stmt = $this->conn->prepare('CALL Human_delete(?)');
        ...
        function Human_updateById(int $id, string $firstName, string $lastName){
            $stmt = $this->conn->prepare('CALL Human_updateById(?,?,?)');
